...
def translate_first_orf(sequence,
    ...
    """
    Return the translated first open-reading frame in the DNA or RNA `sequence`.
    ...
    first_orf = find_orf.find_first_orf(sequence,
            start_codons = start_codons,
            stop_codons = stop_codons)
    translate_orf = translate.translate_sequence(first_orf, genetic_code)
    return translate_orf
...
def main():
    ...
    translate_orf = translate_first_orf(sequence = sequence,
            start_codons = args.start_codon,
            stop_codons = args.stop_codon)
    sys.stdout.write('{}\n'.format(translate_orf))
